    ...
    >
      <div>
        ...
        <motion.div variants={itemVariants} className="mx-auto max-w-[900px]">
          <Heading variant="h2" className="mb-3 md:mb-8">
            About Me
          </Heading>
          <p className="mx-3 font-extralight text-sm md:text-lg">
            ...
            Right now, I&apos;m exploring the world of modern web development
            and sharpening my skills one project at a time.
            <br />
            <br /> I mostly work with Next.js, Tailwind CSS, and Typescript --
            tools I love for how flexible and powerful they are. Whether
            it&apos;s crafting smooth animations, building responsive layouts,
            or experimenting with new UI libraries like Shadcn, I&apos;m always
            down to learn something new and make things better.
          </p>
        </motion.div>
